...
//         $this->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars']))
//             ->assertInertia(
...
//     {
//         $this->signIn()->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 4)
...
//     {
//         $this->signIn($this->user1)->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 5)
...
//     {
//         $this->withoutEvents();
//         $this->signIn($this->user1)->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars', 'q' => '2']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 1)
...
//     {
//         $this->signIn($this->user1)->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars', 'type' => 'public']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 4)
...
//     {
//         $this->signIn($this->user1)->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars', 'type' => 'private']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 1)
...
//     {
//         $this->signIn($this->user2)->get(route('users.show', ['user' => $this->user2, 'tab' => 'stars', 'type' => 'sources']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 4)
...
//     {
//         $this->signIn($this->user2)->get(route('users.show', ['user' => $this->user2, 'tab' => 'stars', 'type' => 'clones']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 1)
...
//     {
//         $this->signIn($this->user1)->get(route('users.show', ['user' => $this->user1, 'tab' => 'stars', 'sort' => 'recently_starred']))
//             ->assertInertia(
//                 fn (Assert $assert) => $assert
//                     ->component('User/Stars')
//                     ->has('packages.data', 5)
