<template>
  <div v-if="pagination.links.length > 3" class="inline-flex justify-center items-center">
    ...
    <div class="flex space-x-1 items-top" v-if="pagination.last_page > 1">
      ...
      >
        ...
        <input
          ...
          v-model="page"
          class="px-2 w-16 h-11 text-center rounded border border-gray-400 shadow-sm lg:h-9 lg:text-sm focus:ring-blue-500 focus:border-blue-500"
        />
        <div class="pr-2 text-gray-600 lg:text-sm">
          页，总共{{ pagination.last_page }}页
        </div>
      </div>
